...
import { paginateQuery, paginateSchema } from '@/database/pagination'
import z from 'zod'
  ...
  methods: {
    async get({ reply, query }) {
      ...
      try {
        ...
        return reply.code(500).send({ message: 'Erro interno do servidor ao listar convites' })
      }
    }
  }
})
